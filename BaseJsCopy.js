var documentConfiguration = {
  ...
  }, 
  {
    ...
    filters: [
      function(requirement) {
        return requirement["Details-Type"] == "Narrative" && requirement["Details-Module Name"] == "Application Registration";
      }
    ],
  ...
  {
    sectionName: "Save Checkpoint List",
    //includeTitle: "h1",
    getData: "requirements",
    filters: [
      function(requirement) {
        return requirement["Details-Type"] == "Save Checkpoints" && requirement["Details-Module Name"] == "Application Registration";
      }
    ],
    ...
    filters: [
      function(requirement) {
        return requirement["Details-Type"] == "Business Scenario" && requirement["Details-Module Name"] == "Application Registration";
      }
    ],
